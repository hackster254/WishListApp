...
<div className="flex flex-col">
    <div className="mb-5">
       ...
       <input type='text' className='w-full py-3 mt-1 border-slate-200
    ...
    <div className="mb-5">
       ...
       <input  type='number' className='w-full py-3 mt-1 border-slate-200
       rounded-lg px-3 focus:outline-none focus:border-slate-500 hover:shadow'
       placeholder='Price'
       value={price}
    ...
    <button type='submit' className='w-full py-3 font-bold text-white bg-indigo-600 hover:bg-indigo-300'>Update</button>
</div>
        </form>
    </div>
  )
